    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("SISTEMAS", "JEFE_VENTAS", "ADMIN")
                        ...
                        .hasAnyRole("SISTEMAS", "JEFE_VENTAS", "ADMINISTRATIVO", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/cotizaciones", "/api/v1/cotizaciones/*")
                        .hasAnyRole("SISTEMAS", "GERENTE", "JEFE_VENTAS", "VENDEDOR", "ADMINISTRATIVO", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/cotizaciones")
                        .hasAnyRole("SISTEMAS", "JEFE_VENTAS", "VENDEDOR", "ADMINISTRATIVO", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/cotizaciones/*/estado")
                        .hasAnyRole("SISTEMAS", "JEFE_VENTAS", "VENDEDOR", "ADMIN")
